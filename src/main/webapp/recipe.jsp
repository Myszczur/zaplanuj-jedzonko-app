...
<form action="/recipe" method="post">
    <div class="center"><input type="text" placeholder="Szukaj przepisu.." name="recipeName">
        <button class="btn btn-color rounded-0 pt-0 pb-0 pr-4 pl-4" type="submit">&nbsp;&nbsp;Szukaj&nbsp;&nbsp;
        </button>
    </div>
</form>
<br>
<section class="mr-4 ml-4">
    <table class="table">
        ...
        <c:forEach var="recipeDao" items="${recipeDao}">
            <tr class="d-flex">
                <th scope="row" class="col-1">${recipeDao.nameId}</th>
                <td class="col-5">${recipeDao.name}</td>
                <td class="col-5">${recipeDao.description}</td>
                <td class="col-1"><a href="<c:url value="recipeOfDetails?id=${recipeDao.nameId}" />"
