        ...
        <div class="dashboard-content border-dashed p-3 m-4 view-height">
          <div class="row border-bottom border-3 p-1 m-1">
            ...
            <div class="col d-flex justify-content-end mb-2 noPadding">
              <a href="add" class="btn btn-success rounded-0 pt-0 pb-0 pr-4 pl-4">Dodaj plan</a>
            </div>
          </div>
          ...
          <div class="schedules-content">
            <table class="table border-bottom">
              ...
              <tr class="d-flex">
                <td class="col-1">${planDAO.planId}</td>
                <td class="col-2">${planDAO.name}</td>
                <td class="col-7">${planDAO.description}</td>
                <td class="col-2 d-flex align-items-center justify-content-center flex-wrap"><a href="#" class="btn btn-danger rounded-0 text-light m-1">Usuń</a>
                  <a href="<c:url value="/app/plan/details/?id=${planDAO.planId}" />"class="btn btn-info rounded-0 text-light m-1">Szczegóły</a>
