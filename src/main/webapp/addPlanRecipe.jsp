                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control" id="choosePlan" name="choosePlan">
                                    <c:forEach var="planDAO" items="${planDAO}">
                                        <option value="${planDAO.planId}">${planDAO.name}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-4">
                                <select class="form-control" id="recipe" name="recipe">
                                    <c:forEach var="recipeDao" items="${recipeDao}">
                                        <option value="${recipeDao.nameId}">${recipeDao.name}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <select class="form-control" id="day" name="day">
                                    <c:forEach var="dayNameDAO" items="${dayNameDAO}">
                                        <option value="${dayNameDAO.id}">${dayNameDAO.name}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                        <div class="col d-flex justify-content-end mb-2 noPadding">
                            <button type="submit" class="btn btn-success rounded-0 pt-0 pb-0 pr-4 pl-4"><b>Zapisz</b>
                            </button>
                        </div>
                    </form>
                </div>
