      ...
      <div class="m-4 p-3 border-dashed view-height">
        ...
        <div class="schedules-content">
          <table class="table">
            ...
            <tr class="d-flex">
              <td class="col-1">${admins.id}</td>
              <td class="col-3">${admins.firstName}</td>
              <td class="col-6">${admins.lastName}</td>
              <td class="col-2 center">
                <a href="/app/userblock?id=${admins.id}"  class="btn btn-danger rounded-0 text-light m-1">Blokuj</a>
              </td>
            </tr>
            </c:forEach>
            </tbody>
